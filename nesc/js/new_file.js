...
$('#calc').on('click', function() {
   ...
   setTimeout(function() {
      multiple = $('.first-select #multiple').hasClass('mui-active');var sdate = moment($('#sdateText').html(), datefmt).startOf('month').toDate().getTime();
      var edate = moment($('.first-select #edateText').html(), datefmt).endOf('month').toDate().getTime();
      ...
      sdate = moment($('.secord-select #sdateText').html(), datefmt).startOf('month').toDate().getTime();
      edate = moment($('.secord-select #edateText').html(), datefmt).endOf('month').toDate().getTime();
